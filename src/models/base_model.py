...
class BaseModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # self.log("train/clean_scale_mean", clean_scale.mean(), prog_bar=False, on_step=True)
        # self.log("train/clean_scale_std", clean_scale.std(unbiased=False), prog_bar=False, on_step=True)
        return loss
