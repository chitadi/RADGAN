...
# ---------------------------------------------------------------------
# Patch cplxmodule transposed convolutions for newer PyTorch (_output_padding signature)
from cplxmodule.nn import CplxConvTranspose1d, CplxConvTranspose3d

def _patch_cplx_output_padding(cls, dims: int):
    if getattr(cls, "_torch_output_padding_patched", False):
        return

    base = torch.nn.modules.conv._ConvTransposeNd._output_padding
    ...
    cls._output_padding = _output_padding
    cls._torch_output_padding_patched = True

_patch_cplx_output_padding(CplxConvTranspose1d, 1)
_patch_cplx_output_padding(CplxConvTranspose2d, 2)
_patch_cplx_output_padding(CplxConvTranspose3d, 3)
# ---------------------------------------------------------------------
